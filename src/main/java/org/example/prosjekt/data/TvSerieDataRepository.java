...
//sette opp en konstruktør
    public TvSerieDataRepository() {
        ...
        theWitcher.addEpisode(new Episode("Wichcraft",1,1,50,LocalDate.now(),"syke hekser som synger og danser hiphop",new Person("navn",45),"https://www.theworkprint.com/wp-content/uploads/2019/12/Refugee.jpg"));
        theWitcher.addEpisode(new Episode("Made of steel",2,1,45,LocalDate.now(),"sNå er di lei av danse så di spiser bruker på mc donlds",new Person("mc chees",42),"https://showsnob.com/files/image-exchange/2016/04/ie_32068-1.jpeg"));
        theWitcher.addEpisode(new Episode("Dont do it",1,2,56, LocalDate.now(),"Di dro deretter til fredrikstad for å se på statuen av han som bærer planke",new Person("planke per",120),"https://m.media-amazon.com/images/M/MV5BYWZlZTc0YmUtZjU0OS00MmU4LThjZjgtZmY1MDI3ZTU4M2YzXkEyXkFqcGdeQXVyMTM2MDI5MzM0._V1_.jpg"));
        theWitcher.addEpisode(new Episode("The End",2,2,66,LocalDate.now(),"Det er kaldt og kjedelig, de drar hjem for å spille dataspill",new Person("spill spiltesen",42),"https://pbs.twimg.com/media/FAJ3togXMAE4jU9.png"));
        ...
        strangerThing.addEpisode(new Episode("Chapter One: The Vanishing of Will Byers",
                1,1,70,LocalDate.now(),"rare mennesker som går rundt og opp og ned og mye rart og enda mere rundt til di er lei for det er jeg",new Person("kadir amini",28),"https://hips.hearstapps.com/hmg-prod/images/stranger-things-season-4-part-2-1653325426.jpeg"));
        strangerThing.addEpisode(new Episode("Chapter Two: The Weirdo on Maple Street",
                2,1,56,LocalDate.now(),"måtte selvsagt skrive en til så her er den siste så er kodesnutten ute",new Person("The End",69),"https://sm.ign.com/ign_in/news/s/stranger-t/stranger-things-season-5-the-title-of-the-first-episode-has_y7fd.jpg"));
